...
# The framework domains run concurrently but have no synchronous phase
# relationship.  The core selector follows the emu PLL wrapper without relying
# on a Quartus-version-specific internal PLL primitive name.
set_clock_groups -asynchronous \
   -group [get_clocks { *|clocks|pll|*|divclk}] \
